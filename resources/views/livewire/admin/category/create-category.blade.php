    ...
    <div class="app-content-header mb-4">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0 fw-bold text-slate-800">Tambah Kategori Baru</h3>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-header bg-white py-3 border-bottom-0">
                            <div class="d-flex align-items-center gap-2 text-indigo-600">
                                ...
                                <h5 class="mb-0 fw-bold text-dark">Form Kategori</h5>
                            </div>
                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control border-start-0 ps-0 @error('category') is-invalid @enderror"
                                            placeholder="Contoh: Fiksi Ilmiah, Teknologi, dll">
                                    </div>
                                    @error('category')
                                    <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text text-muted small mt-1">
                                        Nama kategori harus unik dan belum pernah digunakan sebelumnya.
                                    </div>
                                </div>
                                <div class="mb-4">
